...
def main():
    ...
    parser.add_argument("--login_user_name", dest="login_user_name", help="Login user name")
...
def find_strings(git_url, since_commit=None, max_depth=1000000, printJson=False, do_regex=False, do_entropy=True, surpress_output=True,
                custom_regexes={}, branch=None, repo_path=None, path_inclusions=None, path_exclusions=None, allow={},login_user_name=""):
    output = {"foundIssues": []}
    if repo_path:
